...
{
	return ((value < start) ? start : (value > limit) ? limit
													  : value);
}
...
HYPAPI HYP_FLOAT vector4_distance(const struct vector4 *v1, const struct vector4 *v2)
{
	return HYP_SQRT((v2->x - v1->x) * (v2->x - v1->x) + (v2->y - v1->y) * (v2->y - v1->y) + (v2->z - v1->z) * (v2->z - v1->z) + (v2->w - v1->w) * (v2->w - v1->w));
}
...
HYPAPI HYP_FLOAT matrix2_determinant(const struct matrix2 *self)
{
	...
	determinant =
		self->r00 * self->r11 - self->r10 * self->r01;
...
HYPAPI HYP_FLOAT matrix3_determinant(const struct matrix3 *self)
{
	...
	determinant =
		(A(11) * (A2(22, 33) - A2(32, 23))) - (A(12) * (A2(21, 33) - A2(31, 23))) + (A(13) * (A2(21, 32) - A2(31, 22)));
