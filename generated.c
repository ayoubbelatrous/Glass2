...
*((Renderer**)__tmp3) = (Renderer*)malloc(__tmp1);;const u64 __tmp4 = ((u64)&(*(Renderer **)__tmp3)->ID);
const int __tmp5 = 30;
*((i32*)__tmp4) = (i32)__tmp5;;const Renderer* __tmp6 = *(Renderer **)__tmp3;
return __tmp6;
}
...
const f32 __tmp2;
const u64 __tmp3 = (u64)(&__tmp2);
*((f32*)__tmp3) = (f32)__tmp1;;const Renderer* __tmp4 = RendererAllocate();
const Renderer* __tmp5;
const u64 __tmp6 = (u64)(&__tmp5);
*((Renderer**)__tmp6) = (Renderer*)__tmp4;;const Renderer* __tmp7 = *(Renderer **)__tmp6;
